...
def define_arguments():
    ...
    parser.add_argument("--bucket_name", "-bn", default='csv-to-s3-project-normieshri', help="Name of the S3 bucket")
    parser.add_argument("--object_key", "-ok", default='dirty_store_transactions/dirty_store_transactions.csv', help="Name for the S3 object")
    parser.add_argument("--data_url", "-du", default='https://github.com/normieshri/aws-data-pipeline-deployment/raw/main/dirty_store_transactions.csv', help="URL of the remote CSV file")
